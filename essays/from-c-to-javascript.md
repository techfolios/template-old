...
I think that JavaScript is a good programming language to learn especially for those who are still being introduced to coding. Although it may be easier to use than C, right now I think I need more use with it to see whether or not its flexibility would lead to problems when creating bigger programs. Nonetheless, I look forward to putting these new practices I have learned to good use as I learn how to code in JavaScript.
